...
RSpec.describe "/people", type: :request do
  ...
  let(:valid_attributes) {
    {full_name: "Full Name 1", email: "full.name1@example.com"}
  }

  let(:invalid_attributes) {
    {full_name: "Full Name 2", email: "full.name1example.com"}
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      let(:new_attributes) {
        {full_name: "Full Name 2", email: "full.name2@example.com"}
      }
      ...
      it "updates the requested person" do
        ...
        person.reload
        expect(person.full_name).to eq(new_attributes[:full_name])
      end
